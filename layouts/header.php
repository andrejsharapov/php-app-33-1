...
<body class="m-0 min-h-screen flex flex-col dark:bg-gray-800 dark:text-gray-300">
    ...
    <header class="flex flex-col sm:flex-row gap-y-4 justify-between items-center px-4 py-3 z-10 bg-white shadow-sm">
        ...
        <div class="flex items-center divide-x">
            ...
            <a href="/" title="" class="px-4 py-1 font-bold text-gray-500 hover:text-gray-800">
                Chat
            </a>
            <a href="https://github.com/andrejsharapov/<?php echo $_ENV['APP_NAME']; ?>" title="GitHub project" target="_blank" class="px-4 py-1 font-bold text-gray-500 hover:text-gray-800">
                GitHub
            </a>
        </div>
    </header>